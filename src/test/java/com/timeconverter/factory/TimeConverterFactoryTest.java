...
class TimeConverterFactoryTest {
    ...
    private TimeConverterFactory factory;
    ...
    void setUp() {
        ...
        factory = new TimeConverterFactory(List.of(britishConverter), "en_GB");
    }

    @Test
    void getConverter_shouldReturnBritishConverterForEnGB() {
        TimeConverter converter = factory.getConverter("en_GB");
    ...
    void getDefaultConverter_shouldReturnBritishConverter() {
        TimeConverter converter = factory.getDefaultConverter();
        assertNotNull(converter);
        assertEquals("en_GB", converter.getSupportedLocale());
    }
    ...
    void getConverter_shouldReturnDefaultConverterWhenLocaleIsNull() {
        TimeConverter converter = factory.getConverter(null);
        assertNotNull(converter);
        assertEquals("en_GB", converter.getSupportedLocale());
    }
